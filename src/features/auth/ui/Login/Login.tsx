...
export const Login = () => {
  ...
  const isCaptcha = useAppSelector(selectCaptchaIsRequired);
          ...
          <FormGroup>
            ...
            {isCaptcha && (
              <Box
                ...
                <img src={captchaData?.url} alt="captcha" width={"200px"} />
                <TextField {...register("captcha")}
                           style={{ marginBottom: "20px" }} helperText={"Type symbols from the image"}
                           variant={"standard"} {...register("captcha")} />
              </Box>
            )}
